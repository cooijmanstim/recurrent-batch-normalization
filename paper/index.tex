...
In this paper, we propose a reparameterization of LSTM (an RNN architecture) that brings the benefits of batch normalization to recurrent neural networks.
