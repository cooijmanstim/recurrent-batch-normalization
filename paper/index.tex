...
In a deep neural network, a given layer $l$ receives input samples from a distribution that is defined by the layers below $l$.
As we update the network parameters during the course of training, this distribution varies.
Changes in the input distribution of a layer present a problem as the layer needs to continuously adapt to the new distribution.
This phenomenum is  called the Internal Covariate Shift~\cite{shimodaira2000improving} and reducing it should lead to  faster training.
