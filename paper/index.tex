...
we explore the use of batch-normalized LSTM in a unidirectional Attentive Reader Model~\cite{attentivereader}.\footnote{We thank Çağlar Gülçehre for sharing his implementation (the code is  available at \url{https://github.com/caglar/Attentive_reader}). We also thanks him for sharing his preprocessed version of the CNN dataset.}
...
We thank Çağlar Gülçehre for sharing his implementation of Attentive Reader, providing the processed data to train it on and contributing a paragraph describing the preprocessing.
We also thank David Krueger, Saizheng Zhang, Ishmael Belghazi and Yoshua Bengio for discussions and suggestions.
