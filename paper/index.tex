...
TODO: redo this whole section with new results; the text has already been copied verbatim to the appendix

To demonstrate the generality and practical applicability of our reparameterization,
we explore the use of batch-normalized LSTM in a unidirectional variant of the Attentive Reader Model from~\citet{attentivereader}.
...
\section{Legacy Attentive Reader results}

A previous version of this paper reported results on an idiosyncratic benchmark, which has since been referenced in other works.
We reproduce it here for the record.
