...
[also normprop]
However to our knowledge none of these schemes have yet been transferred to recurrent neural networks.

In this paper, we demonstrate how batch normalization can be used in recurrent neural networks to speed up optimization and improve generalization.
Section~\ref{sec:prerequisites} introduces recurrent neural networks and batch normalization in detail.
