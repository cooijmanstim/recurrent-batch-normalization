...
\begin{table}[!hb]
  ...
  \subtable[MNIST and pMNIST]
  {
    \begin{tabular}{cc}
      Learning Rate: & 1e-2, 1e-3, 1e-4\\
      RMProp Momentum: & 0.5,  0.9\\
      Hidden States Size: & 100 200 400\\
      $\gamma$: & 1e-1, 3e-1, 5e-1, 7e-1, 1.0\\
    \end{tabular}
  }
    \subtable[PennTreeBank]
  {
    \begin{tabular}{cc}
      Learning Rate: & 1e-1, 1e-2, 1e-3, 2e-2\\
      Hidden States: & 800, 1000, 1200, 1500, 2000\\
      $\gamma$: & 1e-1, 3e-1, 5e-1, 7e-1, 1.0\\
      Batch Sizes Size: &  32, 64, 100, 128\\
    \end{tabular}
  }
    \subtable[Text8]
  {
    \begin{tabular}{cc}
      ...
      Hidden States Size: & 500, 1000, 2000, 4000\\
    \end{tabular}
  }
    \subtable[Attentive Reader]
  {
    \begin{tabular}{cc}
      ...
      Hidden States Size: & 60, 120, 240, 280\\
    \end{tabular}
  }
