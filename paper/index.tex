...
This section presents an empirical evaluation of the proposed batch-normalized LSTM on five different tasks. Results show that batch-normalized LSTM achieves convergence faster than a baseline LSTM on all the tasks, and, can also
achieves to better generalization.
