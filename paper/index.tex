...
Long Short Term Memory Network  (LSTM) networks~\cite{lstm}
...
We will focus on the LSTM re-parametrization in this paper. The LSTM recurrent transition is given by:
\begin{eqnarray}
