...
we explore the use of batch-normalized LSTM in a unidirectional Attentive Reader Model~\cite{attentivereader}.\footnote{
  We thank Çağlar Gülçehre for sharing his implementation (the code is  available at \url{https://github.com/caglar/Attentive_reader})
  and for providing the preprocessed CNN dataset.}
...
We are grateful to Çağlar Gülçehre for sharing his implementation of Attentive Reader, providing the processed data to train it on and contributing a paragraph describing the preprocessing.
