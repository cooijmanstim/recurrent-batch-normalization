...
In this section, we review Long Short Term Memory Network  (LSTM) networks which
...
The gate $\vect{o}_t$ defines how much of the memory $\vect{c}_t$ will be ``pass'' to the next timeset.
