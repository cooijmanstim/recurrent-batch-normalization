...
[optimization problems]
 the notorious training issues associated with RNNs, namely vanishing/exploding gradients and the difficulty of learning long-term dependencies~\cite{bengiolongterm}.

There exist a number of variants of the basic RNN given above, some specifically designed to address the problem of vanishing/exploding gradients, such as the Long Short-Term Memory (LSTM) unit~\cite{lstm} and Unitary RNNs~\cite{urnn}.
...
[in this case $\gamma$ and $\beta$ are vectors too but apparently $\gamma$ and the bold $\mathrm{\gamma}$ look identical]
