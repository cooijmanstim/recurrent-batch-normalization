...
(early stopped on validation performance) and compare them to previous works.
\footnote{We do not compare with~\cite{graves2013generating} as they evaluate in a different setting.}
