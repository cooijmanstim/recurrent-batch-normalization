...
%%% TO Add
Training RNNs using first-order stochastic gradient descent (SGD) is notoriously difficult as we need to not only control the dynamics of the forward-propagated activations but also those of the back-propagated gradient~\cite{bengio1994learning,hochreiter1991untersuchungen,pascanudifficulty}.
