...
Indeed, a layer  network needs to continuously adapt to its input distribution which changes by updating the parameters of the layers below.
...
% I've put this back because I believe we do need to say something about the initial state -- tim
