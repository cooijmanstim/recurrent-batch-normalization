...
important information about the initial transient phase as the distribution of activations during the first few timesteps is very different from the stationary distribution. We did observe in practice that using shared statistics hurts the model performance and slowdown the
